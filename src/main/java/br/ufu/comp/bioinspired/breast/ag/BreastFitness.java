...
//                        System.out.println(j + " -- Gene ID: " + i + "{CLASS: " + chromosomeClass.getName() + "} value " + individual.genes().get(i).domainValue() + " "
//                                + individual.genes().get(i).operator() +
//                                "  dataset -- " + breastDataset.dataSet().get(j)[i]
//                                + " {Class: " + datasetClass + "}");
...
//                                        System.out.println("Menor que Equal entrou " + geneValue + " < " + datasetValue);
                                        geneHasMatchedTheOperationalCondition = true;
                                    }
                                }
